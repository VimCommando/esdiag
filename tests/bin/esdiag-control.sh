...
printf '%s\n' '[package]' 'version = "0.16.1"' >"$tmp/repo/Cargo.toml"
...
assert_contains "$tmp/runtime.log" 'build --file docker/Dockerfile . --tag esdiag:latest --tag esdiag:0.16.1'
assert_contains "$tmp/delegate.log" 'image=esdiag:0.16.1'

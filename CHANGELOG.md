...
- Changed setup to activate an eligible Enterprise trial before installing Kibana Agent Builder assets, and assign the bundled ESDiag skill to the default agent.

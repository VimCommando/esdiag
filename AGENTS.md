...
- `plugin/`: distributable Agent Skill package with Claude Code and Codex manifests; `plugin/skills/` is generated by `bin/sync-plugin-skill.sh`, edit `.agents/skills/esdiag/` instead
- `src/`: Rust code

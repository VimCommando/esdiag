...
Sections 1–7 record the completed prototype. Sections 8–11 supersede its conflicting generic URI, bare Cloud target, command-profile, and output-fallback behavior. Self-contained distribution is tracked in a separate OpenSpec change.

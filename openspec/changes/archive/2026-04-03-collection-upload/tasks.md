...
- [x] 1.1 Extend the `collect` subcommand parser to accept an optional `--upload` argument for an Elastic Upload Service upload id or URL while preserving `-u` for `--user`.
